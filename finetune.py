...
from simclr.src.data_finetune_loader import OrientationDataset as FinetuneDataset
...
if __name__ == "__main__":
    train_data = FinetuneDataset(project_dir="./simclr",train_flag=1)
    BATCH_SIZE =  20
    ...
    train(model, train_loader, batch_size = BATCH_SIZE, weight_path = "./simclr/ckpt/epoch_200.pt")
